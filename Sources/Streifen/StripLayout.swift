...
final class StripLayout {
    ...
    /// Apps that enforce an internal minimum width (WhatsApp, Teams, etc.) will
    /// overflow their allocated slot. That is accepted as honest behavior rather
    /// than papered over with learned per-app minimums.
